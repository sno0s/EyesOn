...
def main():
    ...
    ASSETS_PATH = OUTPUT_PATH / Path(r"C:\Users\maath\OneDrive - Instituto Nacional de Telecomunicações\EyesOn Fetin\TkDesigner Interface\build\assets\frame0")
...
def screen1():
    ...
    OUTPUT_PATH = Path(__file__).parent
    ASSETS_PATH = OUTPUT_PATH / Path(r"C:\Users\maath\OneDrive - Instituto Nacional de Telecomunicações\EyesOn Fetin\TkDesigner Interface\build\assets\frame1")
...
def screen2():
    ...
    OUTPUT_PATH = Path(__file__).parent
    ASSETS_PATH = OUTPUT_PATH / Path(r"C:\Users\maath\OneDrive - Instituto Nacional de Telecomunicações\EyesOn Fetin\TkDesigner Interface\build\assets\frame2")
