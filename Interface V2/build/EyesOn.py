...
def main():
    ...
    ASSETS_PATH = OUTPUT_PATH / Path(r"C:\Users\maath\Desktop\EyesOn\Interface V2\build\assets\frame0")
...
def screen1():
    ...
    OUTPUT_PATH = Path(__file__).parent
    ASSETS_PATH = OUTPUT_PATH / Path(r"C:\Users\maath\Desktop\EyesOn\Interface V2\build\assets\frame1")
...
def screen2():
    ...
    OUTPUT_PATH = Path(__file__).parent
    ASSETS_PATH = OUTPUT_PATH / Path(r"C:\Users\maath\Desktop\EyesOn\Interface V2\build\assets\frame2")
